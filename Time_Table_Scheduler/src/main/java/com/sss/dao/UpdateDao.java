...
import com.sss.classModel.PhdGroup;
import com.sss.classModel.Section;
...
public class UpdateDao {
    ...
    public int  UpdatePhdInfo(ArrayList<PhdGroup> phdGroupList) {
        ...
        try {
            ...
            for(int i = 0;i<phdGroupList.size();++i){

                String groupid = phdGroupList.get(i).groupId;
                String groupid1 = groupid+"-mon";
                String groupid2 = groupid+"-tue";
                String groupid3 = groupid+"-wed";
                String groupid4 = groupid+"-thu";
                ...
                String sql1 = "update phdtimetable set p89=\""+phdGroupList.get(i).timeTable.timetable[0][0]+"\",p910=\""+phdGroupList.get(i).timeTable.timetable[0][1]+"\",p1011=\""+phdGroupList.get(i).timeTable.timetable[0][2]+"\",p1112=\""+phdGroupList.get(i).timeTable.timetable[0][3]+"\",p121=\""+phdGroupList.get(i).timeTable.timetable[0][4]+"\",p12=\""+phdGroupList.get(i).timeTable.timetable[0][5]+"\",p23=\""+phdGroupList.get(i).timeTable.timetable[0][6]+"\",p34=\""+phdGroupList.get(i).timeTable.timetable[0][7]+"\",p45=\""+phdGroupList.get(i).timeTable.timetable[0][8]+"\",p56=\""+phdGroupList.get(i).timeTable.timetable[0][9]+"\" where groupid=\""+groupid1+"\"";
                String sql2 = "update phdtimetable set p89=\""+phdGroupList.get(i).timeTable.timetable[1][0]+"\",p910=\""+phdGroupList.get(i).timeTable.timetable[1][1]+"\",p1011=\""+phdGroupList.get(i).timeTable.timetable[1][2]+"\",p1112=\""+phdGroupList.get(i).timeTable.timetable[1][3]+"\",p121=\""+phdGroupList.get(i).timeTable.timetable[1][4]+"\",p12=\""+phdGroupList.get(i).timeTable.timetable[1][5]+"\",p23=\""+phdGroupList.get(i).timeTable.timetable[1][6]+"\",p34=\""+phdGroupList.get(i).timeTable.timetable[1][7]+"\",p45=\""+phdGroupList.get(i).timeTable.timetable[1][8]+"\",p56=\""+phdGroupList.get(i).timeTable.timetable[1][9]+"\" where groupid=\""+groupid2+"\"";
                String sql3 = "update phdtimetable set p89=\""+phdGroupList.get(i).timeTable.timetable[2][0]+"\",p910=\""+phdGroupList.get(i).timeTable.timetable[2][1]+"\",p1011=\""+phdGroupList.get(i).timeTable.timetable[2][2]+"\",p1112=\""+phdGroupList.get(i).timeTable.timetable[2][3]+"\",p121=\""+phdGroupList.get(i).timeTable.timetable[2][4]+"\",p12=\""+phdGroupList.get(i).timeTable.timetable[2][5]+"\",p23=\""+phdGroupList.get(i).timeTable.timetable[2][6]+"\",p34=\""+phdGroupList.get(i).timeTable.timetable[2][7]+"\",p45=\""+phdGroupList.get(i).timeTable.timetable[2][8]+"\",p56=\""+phdGroupList.get(i).timeTable.timetable[2][9]+"\" where groupid=\""+groupid3+"\"";
                String sql4 = "update phdtimetable set p89=\""+phdGroupList.get(i).timeTable.timetable[3][0]+"\",p910=\""+phdGroupList.get(i).timeTable.timetable[3][1]+"\",p1011=\""+phdGroupList.get(i).timeTable.timetable[3][2]+"\",p1112=\""+phdGroupList.get(i).timeTable.timetable[3][3]+"\",p121=\""+phdGroupList.get(i).timeTable.timetable[3][4]+"\",p12=\""+phdGroupList.get(i).timeTable.timetable[3][5]+"\",p23=\""+phdGroupList.get(i).timeTable.timetable[3][6]+"\",p34=\""+phdGroupList.get(i).timeTable.timetable[3][7]+"\",p45=\""+phdGroupList.get(i).timeTable.timetable[3][8]+"\",p56=\""+phdGroupList.get(i).timeTable.timetable[3][9]+"\" where groupid=\""+groupid4+"\"";
                String sql5 = "update phdtimetable set p89=\""+phdGroupList.get(i).timeTable.timetable[4][0]+"\",p910=\""+phdGroupList.get(i).timeTable.timetable[4][1]+"\",p1011=\""+phdGroupList.get(i).timeTable.timetable[4][2]+"\",p1112=\""+phdGroupList.get(i).timeTable.timetable[4][3]+"\",p121=\""+phdGroupList.get(i).timeTable.timetable[4][4]+"\",p12=\""+phdGroupList.get(i).timeTable.timetable[4][5]+"\",p23=\""+phdGroupList.get(i).timeTable.timetable[4][6]+"\",p34=\""+phdGroupList.get(i).timeTable.timetable[4][7]+"\",p45=\""+phdGroupList.get(i).timeTable.timetable[4][8]+"\",p56=\""+phdGroupList.get(i).timeTable.timetable[4][9]+"\" where groupid=\""+groupid5+"\"";
    ...
    public int  UpdateSectionInfo(ArrayList<Section> sectionGroupList) {
        ...
        try {
            ...
            for(int i = 0;i<sectionGroupList.size();++i){

                String groupid = sectionGroupList.get(i).secId;
                String groupid1 = groupid+"-mon";
                String groupid2 = groupid+"-tue";
                String groupid3 = groupid+"-wed";
                String groupid4 = groupid+"-thu";
                ...
                String sql1 = "update sectionstimetable set p89=\""+sectionGroupList.get(i).timeTable.timetable[0][0]+"\",p910=\""+sectionGroupList.get(i).timeTable.timetable[0][1]+"\",p1011=\""+sectionGroupList.get(i).timeTable.timetable[0][2]+"\",p1112=\""+sectionGroupList.get(i).timeTable.timetable[0][3]+"\",p121=\""+sectionGroupList.get(i).timeTable.timetable[0][4]+"\",p12=\""+sectionGroupList.get(i).timeTable.timetable[0][5]+"\",p23=\""+sectionGroupList.get(i).timeTable.timetable[0][6]+"\",p34=\""+sectionGroupList.get(i).timeTable.timetable[0][7]+"\",p45=\""+sectionGroupList.get(i).timeTable.timetable[0][8]+"\",p56=\""+sectionGroupList.get(i).timeTable.timetable[0][9]+"\" where sectionid=\""+groupid1+"\"";
                String sql2 = "update sectionstimetable set p89=\""+sectionGroupList.get(i).timeTable.timetable[1][0]+"\",p910=\""+sectionGroupList.get(i).timeTable.timetable[1][1]+"\",p1011=\""+sectionGroupList.get(i).timeTable.timetable[1][2]+"\",p1112=\""+sectionGroupList.get(i).timeTable.timetable[1][3]+"\",p121=\""+sectionGroupList.get(i).timeTable.timetable[1][4]+"\",p12=\""+sectionGroupList.get(i).timeTable.timetable[1][5]+"\",p23=\""+sectionGroupList.get(i).timeTable.timetable[1][6]+"\",p34=\""+sectionGroupList.get(i).timeTable.timetable[1][7]+"\",p45=\""+sectionGroupList.get(i).timeTable.timetable[1][8]+"\",p56=\""+sectionGroupList.get(i).timeTable.timetable[1][9]+"\" where sectionid=\""+groupid2+"\"";
                String sql3 = "update sectionstimetable set p89=\""+sectionGroupList.get(i).timeTable.timetable[2][0]+"\",p910=\""+sectionGroupList.get(i).timeTable.timetable[2][1]+"\",p1011=\""+sectionGroupList.get(i).timeTable.timetable[2][2]+"\",p1112=\""+sectionGroupList.get(i).timeTable.timetable[2][3]+"\",p121=\""+sectionGroupList.get(i).timeTable.timetable[2][4]+"\",p12=\""+sectionGroupList.get(i).timeTable.timetable[2][5]+"\",p23=\""+sectionGroupList.get(i).timeTable.timetable[2][6]+"\",p34=\""+sectionGroupList.get(i).timeTable.timetable[2][7]+"\",p45=\""+sectionGroupList.get(i).timeTable.timetable[2][8]+"\",p56=\""+sectionGroupList.get(i).timeTable.timetable[2][9]+"\" where sectionid=\""+groupid3+"\"";
                String sql4 = "update sectionstimetable set p89=\""+sectionGroupList.get(i).timeTable.timetable[3][0]+"\",p910=\""+sectionGroupList.get(i).timeTable.timetable[3][1]+"\",p1011=\""+sectionGroupList.get(i).timeTable.timetable[3][2]+"\",p1112=\""+sectionGroupList.get(i).timeTable.timetable[3][3]+"\",p121=\""+sectionGroupList.get(i).timeTable.timetable[3][4]+"\",p12=\""+sectionGroupList.get(i).timeTable.timetable[3][5]+"\",p23=\""+sectionGroupList.get(i).timeTable.timetable[3][6]+"\",p34=\""+sectionGroupList.get(i).timeTable.timetable[3][7]+"\",p45=\""+sectionGroupList.get(i).timeTable.timetable[3][8]+"\",p56=\""+sectionGroupList.get(i).timeTable.timetable[3][9]+"\" where sectionid=\""+groupid4+"\"";
                String sql5 = "update sectionstimetable set p89=\""+sectionGroupList.get(i).timeTable.timetable[4][0]+"\",p910=\""+sectionGroupList.get(i).timeTable.timetable[4][1]+"\",p1011=\""+sectionGroupList.get(i).timeTable.timetable[4][2]+"\",p1112=\""+sectionGroupList.get(i).timeTable.timetable[4][3]+"\",p121=\""+sectionGroupList.get(i).timeTable.timetable[4][4]+"\",p12=\""+sectionGroupList.get(i).timeTable.timetable[4][5]+"\",p23=\""+sectionGroupList.get(i).timeTable.timetable[4][6]+"\",p34=\""+sectionGroupList.get(i).timeTable.timetable[4][7]+"\",p45=\""+sectionGroupList.get(i).timeTable.timetable[4][8]+"\",p56=\""+sectionGroupList.get(i).timeTable.timetable[4][9]+"\" where sectionid=\""+groupid5+"\"";
