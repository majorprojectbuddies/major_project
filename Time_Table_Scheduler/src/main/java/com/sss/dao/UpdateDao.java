...
public class UpdateDao {
    ...
    public int UpdateFacultyInfo(FacultyResponse facultyResponse) {
        ...
        try {
            ...
            String sql;
            sql = "update facultydetails set name=\""+ facultyResponse.name +"\", designation=\""+facultyResponse.designation+"\",noOfHours=" + facultyResponse.noOfHours + ", subject1=\""+facultyResponse.subject1+"\",subject2=\""+facultyResponse.subject2+"\",subject3=\""+facultyResponse.subject1+"\" where facultyid=\""+facultyResponse.facultyid+"\"";
